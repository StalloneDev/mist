...
export default function EditEntrepriseModal({ entreprise, secteurs, isOpen, onClose, onSuccess }: EditEntrepriseModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-xl bg-white border border-border rounded-[2.5rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
                <div className="p-8 border-b border-border bg-surface-2">
                    <div className="flex justify-between items-center">
                        <div>
                            <h2 className="text-2xl font-black text-foreground tracking-tight">Modifier l&apos;Entreprise</h2>
                            <p className="text-muted text-[10px] uppercase tracking-widest font-bold mt-1 opacity-70">Mise à jour des informations CRM</p>
                        </div>
