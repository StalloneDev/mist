    ...
    return (
        <div className="page-wrapper space-y-6 sm:space-y-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-black text-black tracking-tight">Gestion des Entreprises</h1>
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 w-full md:w-auto">
                    ...
                    <Link 
                        ...
                        className="flex justify-center items-center gap-3 px-6 py-3 rounded-2xl bg-white/5 border border-white/10 text-white font-black hover:bg-white/10 transition-all text-sm sm:text-base"
                    >
                        + Ajouter via Visite
                    </Link>
                </div>
