    ...
    return (
        <div className="premium-panel p-8 space-y-8 animate-fade-in">
            <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-black text-foreground tracking-tight uppercase">Identification de l&apos;Entreprise</h3>
            </div>
            ...
            <div className="pt-8 border-t">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-[10px] text-muted font-bold uppercase tracking-wider mt-1">Ajoutez les interlocuteurs clés de cette visite</p>
                    </div>
                    <button 
                        type="button"
                ...
                <div className="space-y-8">
                    {(data.contacts || []).map((contact: any, index: number) => (
                        <div key={index} className="relative p-6 rounded-2xl bg-surface-2 border border-border space-y-6">
                            {index > 0 && (
                                <button
                                    type="button"
